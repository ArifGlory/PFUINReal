 ...
 */
public class RecycleAdapterInduksi1 extends RecyclerView.Adapter<RecycleViewHolderGelCahaya> {


    LayoutInflater inflater;
    Context context;
    Intent i;
    String[] namaAlat ={"Multimeter Digital","Kumparan 1000 Lilitan ","Kumparan 500 Lilitan ","Magnet batang ",
            "Kabel Penghubung ","Selotip"};
    String[] kodeAlat ={"GME 240","PEF 357","PEF 356 ","FLS 20.14/113","KAL 99","-"};
    String[] jmlAlat ={"1","1","1","2","2","1"};

    int[] gambarAlat = {R.drawable.multimeter_digital,R.drawable.kumparan1000,R.drawable.kumparan500,R.drawable.magnetbatang
            ,R.drawable.kabelpenghubung, R.drawable.selotip,};


    public RecycleAdapterInduksi1(final Context context) {
