 ...
 */
public class RecycleAdapterKapasitor extends RecyclerView.Adapter<RecycleViewHolderGelCahaya> {


    LayoutInflater inflater;
    Context context;
    Intent i;
    String[] namaAlat ={"Multimeter Digital","Skalar SPST","Kapasitor 10 µF","Multimeter Digital","Kabel Penghubung"};
    String[] kodeAlat ={"KAL 60/50 A","PEO 502","PE0 502","GME 240","KAL 99"};
    String[] jmlAlat ={"1","1","1","1","5"};

    int[] gambarAlat = {R.drawable.multimeter_digital,R.drawable.saklar_spst,R.drawable.kapasitor10,R.drawable.multimeter_digital,
            R.drawable.kabelpenghubung};


    public RecycleAdapterKapasitor(final Context context) {
